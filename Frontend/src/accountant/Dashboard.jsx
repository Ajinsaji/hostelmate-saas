  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <Card hover className="p-5 cursor-pointer" onClick={() => window.location.href = "/rent-dashboard"}>
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => window.location.href = "/expense-dashboard"}>
          <div className="flex items-center justify-between">
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Vendor Payments Module")}>
          <div className="flex items-center justify-between">
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Treasury Module")}>
          <div className="flex items-center justify-between">
