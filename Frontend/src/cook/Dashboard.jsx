  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Menu Planner")}>
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Recipes & Serving Tool")}>
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-emerald-500/10 text-emerald-400">
              <BookOpen size={22} />
            </div>
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Ingredient Requirements")}>
          <div className="flex items-center gap-3">
        ...
        <Card hover className="p-5 cursor-pointer" onClick={() => toast.info("Opening Food Wastage Tracker")}>
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-rose-500/10 text-rose-400">
              <Trash size={22} />
            </div>
