/**
 * Canonical confirmation text normalization contract (Backend CommonJS).
 *
 * Rules:
...
/**
 * Validates whether the confirmation string matches
 * the expected canonical hostel name after safe normalization.
 *
 * Case-sensitive match.
 */
function isConfirmationMatching(input, expected) {
